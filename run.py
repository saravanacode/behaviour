...
parser = argparse.ArgumentParser(description='Process video file for behavior detection.')
# Add an argument for the input video file
...
if args.input:
    ...
    print("Please provide the input video file path using --input argument.")
    exit()

# Now, you can use the 'video_path' variable instead of hardcoding the video file path.
# For example:
